...
Joueur::Joueur(Image *img, Input input, Arme arme) : Espion(img), cdAtq(0), cdMax(100),  nbRounds(0), input(input), arme(arme) {
}
...
const int Joueur::getCdAtq() {
    return cdAtq;
}

const int Joueur::getCdMax() {
    return cdMax;
}
